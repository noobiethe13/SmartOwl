...
import '../../../core/constants/firebasefield_constants.dart';
...
final communityModelProvider = Provider((ref) {
  return communityModel(firestore: ref.watch(firestoreProvider));
});

class communityModel {
  final FirebaseFirestore _firestore;
  communityModel({required FirebaseFirestore firestore}) : _firestore = firestore;
  ...
  CollectionReference get _communities => _firestore.collection(FirebaseFieldConstants.communitiesCollection);
}
